...
module.exports = {
	...
	theme: {
		...
		screens: {
			...
			md: '100%', // 100% width below the md breakpoint
			lg: '1024px', // Max width of 1024px above the lg breakpoint
			xl: '1280px', // Max width of 1280px above the xl breakpoint
			'2xl': '1536px', // Max width of 1536px above the 2xl breakpoint
			'3xl': '1920px', // Max width of 1920px above the 3xl breakpoint
		},
		extend: {
			colors: {
